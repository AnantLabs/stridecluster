...
public final class HDFSFileSystem {
	...
	private Logger LOG = Logger.getLogger(HDFSFileSystem.class);
	private static final int BUFFERED_SIZE = 1024 * 4;
	private String hdfsRoot = ConfigReader.getEntry("hadoop_index_path");
	private String localIndexRoot = ConfigReader.getEntry("indexStorageDir");
