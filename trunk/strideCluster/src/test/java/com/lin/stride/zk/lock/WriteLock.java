            ...
            do {
                ...
                if (id != null) {
                    ...
                    if (names.isEmpty()) {
                        ...
                        SortedSet<ZNodeName> lessThanMe = sortedNames.headSet(idName);//取出所有比idName小的数据
                        /**
                         * x-160369449046048770-0000000005
                         * x-160369449046048770-0000000006
                         * x-160369449046048770-0000000007  -- 当前节点
                         * x-160369449046048770-0000000008
                         * 取出lessThanMe的结果是
                         * x-160369449046048770-0000000005
                         * x-160369449046048770-0000000006
                         */
                        if (!lessThanMe.isEmpty()) {
                            ZNodeName lastChildName = lessThanMe.last();//取出最后一个,就是06节点.
                            lastChildId = lastChildName.getName();
                            if (LOG.isDebugEnabled()) {
                                LOG.debug("watching less than me node: " + lastChildId);
                            }
                            Stat stat = zookeeper.exists(lastChildId, new LockWatcher());//对06节点进行监控
                            if (stat != null) {
